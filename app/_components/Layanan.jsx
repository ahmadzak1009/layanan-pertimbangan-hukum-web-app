...
function Layanan() {
  ...
  return (
    <section id="layanan">
      <div className="bg-[url('/header.jpg')] bg-bottom">
          ...
          <div className="mx-auto max-w-screen-xl px-4 py-20 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-lg text-center">
              ...
              <p className="mt-4 text-white">
                Layanan yang diberikan oleh Jaksa Pengaca Negara kepada Negara atau Pemerintah,
                dalam bentuk Pendapat Hukum (Legal Openion atau LO) dan/atau Pemdampingan Hukum
                (Legal Assistance atau LA) di bidang perdata dan tata usaha negara dan/atau Audit
                Hukum (Legal Audit) di bidang perdata.
              </p>
            </div>
            ...
            <div className="mt-8 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
              {listLayanan.map((item) => (
                <div
                  className="block bg-primary rounded-xl border border-primary p-8 shadow-xl transition hover:border-black hover:shadow-blue-500/10"
                  // href={item.path}
                >
                  <svg
